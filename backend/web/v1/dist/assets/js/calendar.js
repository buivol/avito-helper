...
(function ($) {
  ...
  Calendar.prototype = {
    ...
    _renderHeader: function _renderHeader() {
      ...
      prevIcon.addClass('fe fe-chevron-left');
      ...
      nextIcon.addClass('fe fe-chevron-right');
    ...
    _renderBody: function _renderBody() {
      ...
      monthsRow.addClass('months-container-row');
      monthsRow.addClass('row');
      ...
      for (var m = 0; m < 12; m++) {
        ...
        monthsRow.append(monthDiv);
      }

      monthsDiv.append(monthsRow);
    ...
    _openContextMenu: function _openContextMenu(elt) {
      ...
      for (var i in events) {
        ...
        icon.addClass('fe fe-chevron-right');
